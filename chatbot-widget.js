(function() {
  ...
  function createInitialPage() {
    ...
    if (existingConversation) {
      askButton.innerHTML = 'Fortsätt konversation <span>&gt;</span>';
    ...
    fetchAgentProfiles().then(agents => {
      ...
      if (onlineAgents.length > 0) {
        ...
        talkToHuman.innerHTML += '<span>Prata med en mänsklig agent</span>';
        ...
        talkToHuman.innerHTML = '';
        talkToHuman.appendChild(agentPhotosContainer);
        talkToHuman.innerHTML += '<span>Inga agenter tillgängliga för tillfället</span>';
  ...
  async function renderChatHistoryView() {
    ...
    newChatButton.innerHTML = 'Ny chatt <span>&gt;</span>';
    ...
    if (conversations.length === 0) {
      ...
      noConversations.textContent = 'Inga konversationer';
      ...
      conversations.forEach((conv, index) => {
        ...
        if (index === 0 && conversations.length > 1) {
          ...
          previousHeader.textContent = 'Tidigare konversationer';
